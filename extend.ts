...
export function mixin<T, S extends unknown[], U>(t: Ctor<T, S>, u: Ftor<U, unknown[]>): Ctor<T & U, S> {
...
export function constr<T, S extends[]>(t: Ftor<T, S>, u: Ctor<T, unknown[]>): Ctor<T, S> {
